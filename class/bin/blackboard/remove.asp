...
response.write("<x>帖子一经删除无法恢复</x><br><x>是否仍要删除?</x><br><button class= 'btn ' style= 'vertical-align:middle;background-color: #555; ' onclick=""location='./'""><span>取消</span></button><button class= 'btn ' style= 'vertical-align:middle;' onclick=""location='./remove.asp?confirmed=1&id="&id&"&tim="&tim&"&uid="&uid&"'""'><span>继续</span></button>")
end if
end if
%>
</body>
